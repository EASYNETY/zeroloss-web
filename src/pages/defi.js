      ...
      <>
        ...
        >
          <main className="main">
            ...
            >
              <div className="svg-shape--top w-100"></div>
                    ...
                    <div className="content">
                      <div className="mb-4">
                        <h1
                          ...
                          style={{ color: "white" }}
                        >
                          <span className="color--yellow">ZEROLOSS</span>FINANCE
                        </h1>
                        <p className="opacity--100">
                          ZEROLOSS FINANCE is a DEX built for ZEROLOSS Ecosystem
                      ...
                      <div className="progress rounded--full mb-6 mr-md-5 mr-xl-10">
                        <div
                          className="progress-bar rounded--full bg-color--green jsElement"
                      ...
                      <div className="form--v7">
                        <form
                          action="#"
                          id="defi"
                          className="form border--around rounded--05 bg-white"
                        >
                          <div className="input-group d-flex">
                            ...
                            >
                              <span id="submit_text" className="btn__text">
                                Notify me
                              </span>
                            </button>
                          </div>
...
<Footer />
                ...
                <div className="container text-center">
                  <div className="row">
                    <div className="col-12 mb-2">
                      <span className="mb-2">
                        <img
                          src="images/Zerolossrtagolds.png"
                          alt="brand-logo"
                        />
                      </span>
          ...
          <link
            rel="stylesheet"
            href="../cdn.jsdelivr.net/gh/fancyapps/fancybox%403.5.7/dist/jquery.fancybox.min.css"
          />
